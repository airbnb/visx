...
export function withParentSize<T extends {}>(BaseComponent: React.ComponentType<T>): React.ComponentClass<{
  debounceTime?: number
} & T, {
...
export function withScreenSize<T extends {}>(BaseComponent: React.ComponentType<T>): React.ComponentClass<{
