...
| defined   |         |          | A [function](https://github.com/d3/d3-shape/blob/master/README.md#area_defined) called by `area.defined()`. |
| curve     |         |          | The [curve function](https://github.com/hshoff/vx/tree/master/packages/vx-curve)                            |
| data      |         |          | An array of x and y data.                                                                                   |
