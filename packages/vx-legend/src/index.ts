...
export { default as CircleShape } from './legends/shapes/Circle';
export { default as LineShape } from './legends/shapes/Line';
export { default as RectShape } from './legends/shapes/Rect';
