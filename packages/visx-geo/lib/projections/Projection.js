...
function Projection(_ref) {
  ...
  }), projectionFunc == null ? void 0 : projectionFunc(currProjection), (graticule == null ? void 0 : graticule.foreground) && /*#__PURE__*/_react.default.createElement(_Graticule.default, _extends({
    graticule: function graticule(ml) {
      return path(ml) || '';
    }
  }, graticule)), (graticuleLines == null ? void 0 : graticuleLines.foreground) && /*#__PURE__*/_react.default.createElement(_Graticule.default, _extends({
    lines: function lines(l) {
      return path(l) || '';
    }
  }, graticuleLines)), (graticuleOutline == null ? void 0 : graticuleOutline.foreground) && /*#__PURE__*/_react.default.createElement(_Graticule.default, _extends({
    outline: function outline(p) {
      return path(p) || '';
    }
  }, graticuleOutline)));
