...
> = BaseStackProps<Datum, Key> & {
  /** @seygai/visx-scale or d3-scale that takes an x value and maps it to an x axis position. */
  xScale: XScale;
  /** @seygai/visx-scale or d3-scale that takes a y value and maps it to an y axis position. */
  yScale: YScale;
