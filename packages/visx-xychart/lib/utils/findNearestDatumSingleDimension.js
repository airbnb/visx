...
exports.default = findNearestDatumSingleDimension;
...
function findNearestDatumSingleDimension(_ref) {
  ...
  if ('invert' in coercedScale && typeof coercedScale.invert === 'function') {
    var bisect = (0, _d3Array.bisector)(accessor).left; // find closest data value, then map that to closest datum
    ...
    var rangePoints = (0, _d3Array.range)(sortedRange[0], sortedRange[1], coercedScale.step());
    var domainIndex = (0, _d3Array.bisectLeft)(rangePoints, scaledValue); // y-axis scales may have reverse ranges, correct for this
