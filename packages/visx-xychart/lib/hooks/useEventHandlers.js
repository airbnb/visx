...
function usePointerEventHandlers(_ref) {
  ...
  var _ref2 = (0, _react.useContext)(_DataContext.default),
    ...
    xScale = _ref2.xScale,
    yScale = _ref2.yScale;
  var findNearestDatum = findNearestDatumProps || (horizontal ? _findNearestDatumY.default : _findNearestDatumX.default);
