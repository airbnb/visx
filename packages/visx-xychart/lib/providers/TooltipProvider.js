...
function TooltipProvider(_ref) {
  ...
  var showTooltip = (0, _react.useRef)(function (_ref2) {
    ...
    updateTooltip(function (_ref3) {
      ...
      var currNearestDatumDistance = (currData == null ? void 0 : currData.nearestDatum) && (0, _isValidNumber.default)(currData.nearestDatum.distance) ? currData.nearestDatum.distance : Infinity;
      return {
        tooltipOpen: true,
