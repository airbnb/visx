...
import { Connector as BaseConnector } from "@seygai/visx-annotation";
import { ConnectorProps as BaseConnectorProps } from "@seygai/visx-annotation/lib/components/Connector";
