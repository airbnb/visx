...
export default function TooltipProvider(_ref) {
  ...
  var showTooltip = useRef(function (_ref2) {
    ...
    updateTooltip(function (_ref3) {
      ...
      var currNearestDatumDistance = (currData == null ? void 0 : currData.nearestDatum) && isValidNumber(currData.nearestDatum.distance) ? currData.nearestDatum.distance : Infinity;
      return {
        tooltipOpen: true,
