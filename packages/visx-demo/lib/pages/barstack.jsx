...
function BarStackPage() {
    return (<Show events margin={{ top: 80, right: 0, bottom: 0, left: 0 }} component={BarStack} title="Bar Stack" codeSandboxDirectoryName="visx-barstack" packageJson={packageJson}>
      {BarStackSource}
    </Show>);
}
