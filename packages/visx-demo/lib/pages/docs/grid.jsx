...
var components = [GridRows, GridColumns, Grid, GridRadial, GridAngle, GridPolar];
var examples = [AxisTile, BarStackTile, ThresholdTile, LineRadialTile];
function GridDocs() {
    return (<DocPage components={components} examples={examples} readme={GridReadme} visxPackage="grid"/>);
}
