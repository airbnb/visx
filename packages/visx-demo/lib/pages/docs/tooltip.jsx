...
var examples = [TooltipTile, DotsTile, BarStackHorizontalTile, StatsPlotTile, AreaTile];
var components = [TooltipWithBounds, Tooltip, Portal, useTooltip, useTooltipInPortal];
function TooltipDocs() {
    return (<DocPage components={components} examples={examples} readme={TooltipReadme} visxPackage="tooltip"/>);
}
