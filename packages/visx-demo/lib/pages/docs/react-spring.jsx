...
var components = [AnimatedAxis, AnimatedGridColumns, AnimatedGridRows];
var examples = [AxisTile];
function ReactSpringDocs() {
    return (<DocPage components={components} examples={examples} readme={ReactSpringReadme} visxPackage="react-spring"/>);
}
