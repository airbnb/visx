...
var components = [Pattern, Circles, Hexagons, Lines, Path, Waves];
var examples = [PatternsTile, StreamGraphTile, StatsPlotTile];
function PatternDocs() {
    return (<DocPage components={components} examples={examples} readme={PatternReadme} visxPackage="pattern"/>);
}
