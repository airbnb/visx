...
var components = [Cluster, Pack, Partition, Tree, Treemap];
var examples = [PackTile, TreemapTile, DendrogramsTile, LinkTypesTile, TreesTile];
function HierarchyDocs() {
    return (<DocPage components={components} examples={examples} readme={HierarchyReadme} visxPackage="hierarchy"/>);
}
