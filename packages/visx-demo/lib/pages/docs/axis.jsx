...
var components = [Axis, AxisBottom, AxisLeft, AxisRight, AxisTop];
var examples = [AxisTile, BarStackTile, ThresholdTile];
function AxisDocs() {
    return (<DocPage components={components} examples={examples} readme={AxisReadme} visxPackage="axis"/>);
}
