...
var components = [Linear, Ordinal, Quantile, Size, Threshold, Legend];
var examples = [LegendsTile];
function LegendDocs() {
    return (<DocPage components={components} examples={examples} readme={LegendReadme} visxPackage="legend"/>);
}
