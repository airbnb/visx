...
var components = [Graph, Nodes, Links, DefaultNode, DefaultLink];
var examples = [NetworkTile];
function NetworkDocs() {
    return (<DocPage components={components} examples={examples} readme={NetworkReadme} visxPackage="network"/>);
}
