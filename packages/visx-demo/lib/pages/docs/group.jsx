...
var examples = [PatternsTile, RadarTile, PiesTile, TreemapTile, StatsPlotTile, LineRadialTile];
function GroupDocs() {
    return (<DocPage components={components} examples={examples} readme={GroupReadme} visxPackage="group"/>);
}
