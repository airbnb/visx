...
function BarGroupPage() {
    return (<Show events margin={{ top: 80, right: 0, bottom: 80, left: 0 }} component={BarGroup} title="Bar Group" codeSandboxDirectoryName="visx-bargroup" packageJson={packageJson}>
      {BarGroupSource}
    </Show>);
}
