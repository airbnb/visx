...
function Description(_a) {
    var width = _a.width;
    return (<div style={{ width: width, fontSize: 14, lineHeight: '1.5em' }}>
...
function ThresholdPage() {
    return (<Show component={Threshold} title="Threshold" description={Description} codeSandboxDirectoryName="visx-threshold" packageJson={packageJson}>
      {ThresholdSource}
    </Show>);
}
