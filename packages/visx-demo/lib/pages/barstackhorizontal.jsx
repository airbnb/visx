...
function BarStackHorizontalPage() {
    return (<Show events margin={{
        top: 80,
        left: 80,
        right: 40,
        bottom: 100,
    }} component={BarStackHorizontal} title="Bar Stack Horizontal" codeSandboxDirectoryName="visx-barstack-horizontal" packageJson={packageJson}>
