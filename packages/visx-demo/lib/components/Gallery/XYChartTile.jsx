...
var tileStyles = { background: '#222' };
export default function XYChartITile() {
    return (<GalleryTile title="XYChart" description="<XYChart />" exampleRenderer={XYChartWrapper} exampleUrl="/xychart" tileStyles={tileStyles} detailsHeight={0}/>);
}
