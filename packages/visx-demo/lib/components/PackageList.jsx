...
export default function PackageList(_a) {
    var emphasizePackage = _a.emphasizePackage, compact = _a.compact, grid = _a.grid;
    var HeaderElement = compact ? 'h6' : 'h3';
    return (<>
        ...
        <div>
          ...
          <ul>
            ...
            <li className={cx(emphasizePackage === 'event' && 'emphasize')}>
              ...
              {!compact && (<p>Utilities for computing svg coordinates from mouse or touch events</p>)}
            </li>
