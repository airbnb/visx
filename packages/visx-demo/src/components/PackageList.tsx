        ...
        <div>
          ...
          <ul>
            ...
            <li className={cx(cx(emphasizePackage === "curve" && "emphasize"))}>
              ...
              {!compact && <p>d3 line interpolators for @seygai/visx-shape</p>}
            </li>
        ...
        <div>
          ...
          <ul>
            ...
            <li className={cx(emphasizePackage === "hierarchy" && "emphasize")}>
              ...
              {!compact && (
                <p>Components to visualize hierarchical or nested data</p>
              )}
            </li>
            ...
            <li
              className={cx(emphasizePackage === "react-spring" && "emphasize")}
            >
            ...
            <li className={cx(emphasizePackage === "xychart" && "emphasize")}>
              ...
              {!compact && (
                <p>
                  A chart-level API built on & integrated with several other
                  visx building blocks
                </p>
              )}
            </li>
          </ul>
        ...
        <div>
          ...
          <ul>
            ...
            <li className={cx(emphasizePackage === "voronoi" && "emphasize")}>
              ...
              {!compact && (
                <p>Partition points in a chart to improve user interaction</p>
              )}
            </li>
        ...
        <div>
          ...
          <ul>
            ...
            <li className={cx(emphasizePackage === "event" && "emphasize")}>
              ...
              {!compact && (
                <p>
                  Utilities for computing svg coordinates from mouse or touch
                  events
                </p>
              )}
            </li>
            ...
            <li className={cx(emphasizePackage === "gradient" && "emphasize")}>
              ...
              {!compact && (
                <p>Utilities for making making color gradient definitions</p>
              )}
            </li>
        ...
        <div>
          ...
          <ul>
            <li className={cx(emphasizePackage === "bounds" && "emphasize")}>
              ...
              {!compact && (
                <p>Detect the bounding box of an element & its parent</p>
              )}
            </li>
            ...
            >
              ...
              {!compact && (
                <p>Utilities to make responsive visualizations easy</p>
              )}
            </li>
