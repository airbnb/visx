...
var sampleSize = 1000;
export default function genStats( /** Number of stat distributions to generate. */
number, /** Function which generates a random number. */
random, /** Function which generates an offset for each data point / invocation of random. */
randomOffset) {
  if (random === void 0) {
